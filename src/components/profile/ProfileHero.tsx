      ...
      <div className="hero-body">
        ...
        <div className="hero-top-row">
          <div>
            ...
            <div className="hero-headline">Aspiring full-stack developer · Building things students actually use</div>
            ...
            <div className="social-row mt-4">
              <a href={socialLinks?.github || '#'} className="social-btn" title="GitHub">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M9 19c-4.3 1.4-4.3-2.5-6-3m12 5v-3.5c0-1 .1-1.4-.5-2 2.8-.3 5.5-1.4 5.5-6a4.6 4.6 0 0 0-1.3-3.2 4.2 4.2 0 0 0-.1-3.2s-1.1-.3-3.5 1.3a12.3 12.3 0 0 0-6.2 0C6.5 2.8 5.4 3.1 5.4 3.1a4.2 4.2 0 0 0-.1 3.2A4.6 4.6 0 0 0 4 9.5c0 4.6 2.7 5.7 5.5 6-.6.6-.6 1.2-.5 2V21"/></svg>
              </a>
              <a href={socialLinks?.linkedin || '#'} className="social-btn" title="LinkedIn">
              ...
              <a href={socialLinks?.portfolio || '#'} className="social-btn" title="Portfolio">
              ...
              <a href={socialLinks?.resume || '#'} className="social-btn" title="Resume">
          ...
          <div className="hero-actions">
            <Button className="hero-btn hero-btn-outline">Share Profile</Button>
            <Button className="hero-btn hero-btn-outline">Download Resume</Button>
            <Button className="hero-btn hero-btn-primary">Edit Profile</Button>
          </div>
        </div>
